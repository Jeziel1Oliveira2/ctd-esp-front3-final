...
import { CheckoutDispatchContextData } from './types/checkoutDispatch';
import { CheckoutStateContextData } from './types/checkoutState';
...
export const CheckoutDispatchProvider = CheckoutDispatchContext.Provider;
